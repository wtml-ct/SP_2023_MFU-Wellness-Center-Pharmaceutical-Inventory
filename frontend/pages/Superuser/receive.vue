        ...
        <div>
          ...
          <v-card class="pa-5">
            ...
            <v-row no-gutters>
              ...
              <v-col cols="3">
                <v-text-field
                  v-model="editedItem.sc_delivery"
                  label="หมายเลขเลขใบส่งของ"
                  type="number"
                  min="0"
                  :rules="numberOnly() && rules.validate"
                  rounded
              ...
              <v-col cols="3">
                <v-text-field
                  ...
                  min="0"
                  :rules="numberOnly() && rules.validate"
                  label="ระบุจำนวนที่ต้องการนำเข้า"
                  rounded
                  required
                  outlined
                  dense
              ...
              <v-col cols="3">
                <v-menu
                  ...
                  :return-value.sync="editedItem.sc_import"
                ...
                >
                  ...
                  >
                    ...
                    <v-btn
                      text
                      color="primary"
                      @click="$refs.menuimport.save(editedItem.sc_import)"
                    >
                      ยืนยัน
                    </v-btn>
                  </v-date-picker>
              ...
              <v-col cols="3">
                <v-menu
                  ...
                  v-model="menuexp"
                  :close-on-content-click="false"
                  :return-value.sync="editedItem.sc_exp"
                  transition="scale-transition"
                  offset-y
                  min-width="auto"
                >
                  ...
                  >
                    ...
                    <v-btn
                      text
                      color="primary"
                      @click="$refs.menuexp.save(editedItem.sc_exp)"
                    >
                      ยืนยัน
                    </v-btn>
                  </v-date-picker>
              ...
              <v-col cols="1">
                <v-card-text class="ml-1" style="color: black"
                  >นำเข้าจาก</v-card-text
                >
              </v-col>
              <v-col cols="3">
                <v-autocomplete
                  v-model="editedItem.from_warehouse"
                  :rules="rules.validate"
                  :items="from_wh"
                  return-object
...
export default {
  ...
  methods: {
    ...
    //       (item) => item.sc_id > "IM30000000" && item.sc_id <= "IM40000000"
    //     );
    ...
    //     } else {
    //       this.editedItem.sc_id = "IM30000001";
    //     }
    //   });
    // },
    getStatus(item) {
      ...
      if (item.status_id == 0) {
        ...
        console.log(item.from_warehouse);
        this.dialogAccept = true;
        // this.editedItem.sc_id = item.sc_id;
        // this.editedItem.status_id = item.status_id + 1 ;
        // console.log(this.editedItem.sc_id);
        // console.log(this.editedItem.status_id);
        // console.log(this.editedItem);
        // this.$axios.put("/api/stockcards/", this.editedItem);
      } else {
        console.log("1");
      }
    },
    ...
    async deleteItemConfirm() {
      ...
      await this.$axios.put("/api/stockcards/delete", { sc_id });
      this.closeDelete();
    },
    closeDelete() {
